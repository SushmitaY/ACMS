...
def Reccommendation(model, pred_acc):
	feedback_data = pd.read_csv("/home/tanya/Documents/ACMS_Form/feedback.csv", error_bad_lines = False)
	unpredected_data = feedback_data.tail(1)
	feedback_data = feedback_data.iloc[:-1, :]
	feedback_data.to_csv('/home/tanya/Documents/ACMS_Form/feedback.csv', index=False)
	
	unpredected_data['isLockerRecommended'] = pred_acc[0]
	if pred_acc[0] == 0:
		unpredected_data['isLockerUsed'] = 0
	with open('/home/tanya/Documents/ACMS_Form/feedback.csv', 'a') as f:
...
def Classify(request):
	...
	with open('/home/tanya/Documents/ACMS_Form/feedback.csv', 'a') as feedback_data:
